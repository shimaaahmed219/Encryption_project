...
import MofaStatus from "./MofaStatus";
...
export default function ForginDesc({ search }) {
        ...
        .map((user, index) => (
          ...
          >
            {/* name */}
               ...
               <span className="xl:text-[17px] sm:flex hidden mx-2 text-[15px] text-yellowAcc ">
                {index + 1}
              </span>
              -
              <img
                className="md:w-[40px]  md:h-[40px] ml-1 w-[25px] h-[25px] rounded-full"
              ...
              <span className="  font-roboto flex  mt-1 xl:text-[14px] text-[10px]  text-greenD mx-3 capitalize">
               ...
               <div className=" w-[13%] xl:flex hidden   items-center text-[17px] text-greenAcc">
               {user.updated_at.substring(0, 10)}
               </div>
               <div className="   w-[12%] lg:flex hidden  items-center " >
             <MofaStatus user={user} setClient={setClient}/>
               </div>
               <div className="  lg:w-[18%] w-[30%] flex justify-between items-center">
               <button
                onClick={() => handleOpenModal(user)}
                className="md:text-[14px] px-2 text-[10px] font-normal text-white bg-yellowAcc sm:h-[34px] h-[20px]  md:w-[100px] rounded-[10px] md:rounded-[25px] flex items-center justify-center"
              >
