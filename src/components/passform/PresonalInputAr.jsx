      ...
      <div className="md:px-10 md:grid xl:grid-cols-4 lg:grid-cols-3 gap-x-5 md:grid-cols-2 flex flex-col-reverse  pt-5 text-greenAcc font-roboto text-xl m-auto font-medium">
        ...
        <div className="w-[100%] flex flex-col justify-center ">
          ...
          <input
            ...
            type="text"
            className={` xl:w-[240px] bg-transparent w-[99%] text-[18px] h-[50px] focus:outline-none   px-[20px] py-[6px] rounded-input border-[1px] border-yellowAcc `}
          />
          {/* third name errors */}
        ...
        <div className="w-[100%] flex flex-col justify-center ">
          ...
          <input
            ...
            className={` xl:w-[240px]  w-[95%] h-[50px] bg-transparent text-[18px] focus:outline-none  px-[20px] py-[6px] rounded-input border-[1px] border-yellowAcc `}
          />
