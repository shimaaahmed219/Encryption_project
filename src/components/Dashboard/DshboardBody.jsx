...
export default function DshboardBody() {
  return (
    <div className="lg:w-[79%] w-full ms-auto min-h-screen lg:px-20 mt-20">
        <div className="w-full rounded-[40px] lg:h-[264px] bg-Dashboard lg:flex-row flex-col flex justify-between">

<div className="lg:w-[45%] text-center py-10 px-6">
...
<img src={grop}  className="absolute top-[20px] left-[-140px] lg:block hidden"/>
    <img src={img1} className="absolute ml-[-210px] mt-[-30px]"/>
    <img src={img2}  className="z-50"/>
    <img src={grop1}  className="absolute bottom-3 right-[-60px] lg:block hidden"/>
